      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose dark:prose-invert max-w-none mx-auto text-lg leading-relaxed">
            ...
            <p>
              We believe that culture is a living, breathing entity, and our app is designed to bring it to life for you. Whether you're a seasoned traveler, a curious foodie, or someone looking to reconnect with their roots, KALA offers a personalized journey into the heart of India.
            </p>
          </div>
