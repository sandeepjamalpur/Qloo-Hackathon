...
import { Menu, Home, Heart, Settings2, UtensilsCrossed, Landmark, PartyPopper, MapPin, LogIn, UserPlus } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/places', label: 'Places', icon: MapPin, public: true },
          ...
          <div className="container relative z-10 mx-auto flex h-16 items-center px-4 md:px-6">
            ...
            <div className="hidden md:flex items-center gap-2 ml-auto">
              <div className={cn("h-6 w-px", isHomePage ? 'bg-white/20' : 'bg-border')}></div>
                {!user && (
                  <>
                    <Button asChild variant="ghost" className={cn(isHomePage ? 'text-white/90 hover:bg-white/10 hover:text-white' : '')}>
                      ...
                      {visibleNavItems.map((item) => {
                          ...
                          <SheetClose asChild key={item.href}>
                              ...
                              <Button
                                  ...
                                  className={cn(
                                      "w-full justify-start gap-3 text-base h-auto py-3",
                                      isActive && "font-bold"
                                  )}
                              >
                       ...
                       <SheetClose asChild>
                          <Link href="/liked">
                            <Button
                              ...
                              className="w-full justify-start gap-3 text-base h-auto py-3"
                            >
