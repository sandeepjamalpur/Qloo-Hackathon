...
export function FestivalSearch({ onSearch, loading }: FestivalSearchProps) {
  ...
  const handleSearch = (searchQuery?: string) => {
    ...
    onSearch({ 
        query: finalQuery.trim() || 'famous festivals', 
  ...
  const popularSearches = [
    "Diwali", "Holi", "Durga Puja", "Navaratri", 
    "Ganesh Chaturthi", "Onam", "Pongal", "Bihu"
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-8">
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <p className="text-[11px] text-muted-foreground/70 -mt-4">Type "Festival" to view festivals by state.</p>
