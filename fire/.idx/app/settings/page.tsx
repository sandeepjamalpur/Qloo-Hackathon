...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from 'fire/src/components/ui/card';
import { Separator } from 'fire/src/components/ui/separator';
import { Settings, Palette, UserCircle, LogOut, FileText, Shield, Info } from 'lucide-react';
import { ThemeToggle } from 'fire/src/components/ThemeToggle';
      ...
      <div className="max-w-2xl mx-auto space-y-10">
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Manage your account settings and sign out.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
             <div className="flex items-center justify-between">
                ...
                {/* Placeholder for a "Change Email" button or similar */}
             </div>
             <Separator />
