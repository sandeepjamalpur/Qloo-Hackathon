...
import { generateInitialRecommendations } from 'fire/src/app/actions';
    ...
    try {
      ...
      if (result && result.recommendations) {
        ...
        toast({
          ...
          description: 'The AI could not find any recommendations for your prompt. Please try a different one.',
        });
      }
    } catch (error) {
      console.error(error);
