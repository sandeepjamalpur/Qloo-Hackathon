      ...
      if (result && result.recommendations) {
        ...
        if (result.recommendations.length === 0) {
            toast({
              ...
              description: "The AI service might be busy. Please try again in a moment.",
            });
        }
      } else {
        ...
        toast({
          variant: 'destructive',
          title: 'No Recommendations Found',
          description: "We couldn't find anything matching your search. Please try another prompt.",
        });
      }
    } catch (error: any) {
        console.error(error);
                ...
                <section className="text-center bg-muted/50 py-16 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                        ...
                        <CardContent className="p-6">
                            ...
                            <p className="text-muted-foreground text-sm mb-4">Local delicacies that define communities, from the savory chaat of Delhi to the spicy vada pav of Mumbai, celebrating the rich diversity of Indian street food.</p>
                ...
                <section className="space-y-12">
                    <div className="text-center">
                        ...
                        <p className="text-muted-foreground max-w-3xl mx-auto mt-2">
                            Every culture has stories that define its essence - tales of resilience, creativity, and adaptation. We celebrate the keepers of tradition who ensure cultural heritage thrives in our modern world.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-4">
                            <Image
                                src="https://news.artnet.com/app/news-upload/2024/08/GettyImages-542378434-1024x678.jpg"
                            ...
                            />
                            <h3 className="font-headline text-2xl font-bold pt-2">Architectural Marvels</h3>
                            <p className="text-muted-foreground">From the majestic Himalayas to the tranquil backwaters, India's diverse geography is matched only by the splendor of its architecture. Explore ancient temples carved from single rocks, magnificent forts that whisper tales of bygone eras, and serene palaces that reflect centuries of artistic fusion.</p>
                        </div>
                        <div className="space-y-4">
                             <Image
                                src="https://images.unsplash.com/photo-1688820661462-a44e4b2770e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHwxOHx8a2F0aGthbGklMjBkYW5jZXxlbnwwfHx8fDE3NTMzNzA2MDh8MA&ixlib=rb-4.1.0&q=80&w=1080"
                                alt="A person weaving on a traditional loom, with colorful threads creating an intricate pattern."
                                width={600}
                                height={600}
                                className="rounded-lg shadow-lg aspect-square object-cover"
                                data-ai-hint="indian artisan"
                            />
                            <h3 className="font-headline text-2xl font-bold pt-2">Living Traditions</h3>
                             <p className="text-muted-foreground">Culture in India is not just in monuments, but in the hands of its artisans, the rhythms of its musicians, and the recipes of its chefs. Discover the intricate art of block-printing in Rajasthan, the mesmerizing movements of a Kathakali dancer in Kerala, and the vibrant storytelling traditions that bring ancient epics to life.</p>
                        </div>
                    </div>
                </section>
            </div>
